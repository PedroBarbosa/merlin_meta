...
public class ChebiAPIInterface {
	...
	public static String getChebiEntityByName(String metabolite_name, double searchScore) throws Exception{
		...
		for (LiteEntity liteEntity : resultList )
		{
			...
			{
				//System.out.println(liteEntity.getSearchScore());
				//System.out.println("INCLUDING CHEBI SEARCH RESULT. VERIFY "+metabolite_name+" (ChEBI name: "+liteEntity.getChebiAsciiName()+") ANNOTATION!!!");
				if(searchScore==-1)
				{
					return liteEntity.getChebiId();
				}
		...
		//System.out.println("ChEBI metabolite ID for "+metabolite_name+" not found!");
		return null;
	}
	...
	//		catch ( ChebiWebServiceFault_Exception e )
		//		{
		//			System.out.println(metabolite_name);
