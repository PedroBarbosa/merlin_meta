...
public class Connection implements Externalizable {
	...
	/**
	 * @return the mysqlMutithread
	 */
	public MySQLMultiThread getMysqlMutithread() {
		return mysqlMutithread;
	}

	/**
	 * @param mysqlMutithread the mysqlMutithread to set
	 */
	public void setMysqlMutithread(MySQLMultiThread mysqlMutithread) {
		this.mysqlMutithread = mysqlMutithread;
	}
