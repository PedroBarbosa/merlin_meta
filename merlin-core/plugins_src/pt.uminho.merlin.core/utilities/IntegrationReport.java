...
public class IntegrationReport {
	 ...
	 * @param oldLocusTag
	 */
	public void saveLocusTagReport(String database, Map<String, String> oldLocusTag){
		// New locus Tags
		...
		try
		{
			if(!new File("reports/"+database).exists())
			{
				new File("reports/"+database).mkdir();
			}
			out = new BufferedWriter(new FileWriter("reports/"+database+"/LocusTagIntegrationReport.txt"));
	 ...
	 * @param geneNames
	 */
	public void saveGeneNameReport( String database, Map<String, List<String>> existingGeneNames, Map<String, String> homologyGeneNames, Map<String, String> geneNames){
		...
		try
		{
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+"/GeneNameIntegrationReport.txt"));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
	 ...
	 * @param enzymes
	 */
	public void saveEnzymesReport(String database, Map<String, Set<String>> existingEnzymes , Map<String, Set<String>> homologyEnzymesData, Map<String, Set<String>> integratedEnzymes){
		//for each existing enzyme set and is exists Homology enzyme set
		...
		try
		{
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+"/EnzymesIntegrationReport.txt"));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
	 ...
	 * @param proteinNames
	 */
	public void saveProteinNamesReport(String database, Map<String, List<String>> existingProducts, Map<String, String> homologyProductsData, Map<String, String> proteinNames){
		...
		try
		{
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+"/ProteinNamesIntegrationReport.txt"));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
	 ...
	 */
	public void saveGeneNamesConflicts(String database, Map<String, String> newNameConflicts) {
		StringBuffer strInput=new StringBuffer();
		...
		try
		{
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+"/GeneNameConflictsReport.txt"));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
	 ...
	 */
	public void saveProteinConflicts(String database, Map<String, String> newProductsConflicts) {
		StringBuffer strInput=new StringBuffer();
		...
		try
		{
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+"/ProteinNameConflictsReport.txt"));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
	 ...
	 */
	public void pathwaysIntegrationReport(String database, Map<String,Set<String>> allPathways, Map<String,Set<String>> exists, Map<String,Set<String>> homologyEnzymesData) {
		...
		{//complete pathways
			...
			this.createFile(database, "/Complete_Pathways.xls", strInput);
		}
		...
		{//complete pathways
			...
			this.createFile(database, "/Incomplete_Pathways.xls", strInput);
		}
		...
		this.createFile(database, "/New_Pathway.xls", strInput);
		...
		this.createFile(database, "/New_enzymes.xls", strInput);
		...
		this.createFile(database, "/Existing_enzymes.xls", strInput);
	}
	 ...
	 * @param strInput
	 */
	private void createFile(String database, String fileName, StringBuffer strInput){
		BufferedWriter out;
		try
		{
			if(!new File("reports/"+database).exists())
			...
			out = new BufferedWriter(new FileWriter("reports/"+database+fileName));
			out.write(strInput.toString());
			out.close();
		}
		catch (IOException e) {e.printStackTrace();}
