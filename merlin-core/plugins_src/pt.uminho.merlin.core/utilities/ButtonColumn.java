...
public class ButtonColumn implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5129372821663670916L;
	private EventListener eventListener;
	private Map<Integer, JButton> valueArray;
	private MouseListener mouseListener;


	public ButtonColumn(JTable jTable, int column, EventListener eventListener, MouseListener mouseListener){
		super();
	...
	private JButton createButton(){
		...
		button.setIcon(new CreateImageIcon(new ImageIcon(getClass().getClassLoader().getResource("icons/Search.png")),0.05).resizeImageIcon());
