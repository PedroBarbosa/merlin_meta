	...
	private void parseStream(CheckBlastResult cbf){
		...
		try {
			...
			if(cbf.isBlastResultOK()) {
				...
				if(cbf.isSimilarityFound()) {
					...
					if(this.query == null || this.query.isEmpty()) {
						...
						System.out.println("Read BLAST to List query:\t"+this.query);
						System.out.println("Read BLAST to List databaseId:\t"+this.dbid);
						System.out.println("Read BLAST to List program:\t"+this.program);
						System.out.println("Read BLAST to List version:\t"+this.version);
						System.out.println("Read BLAST to List null or empty query");
						this.setReprocessQuery(true);
					}
				}
				else {
			...
			if(cbf.isSimilarityFound()) {
				...
				this.setReprocessQuery(true);
				System.out.println("Read Blast Exception.");
				ex.printStackTrace();}
		}
		this.setSimilarityFound(cbf.isSimilarityFound());
	}
