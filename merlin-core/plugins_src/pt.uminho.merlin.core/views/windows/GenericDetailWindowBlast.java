...
import utilities.TextAreaEditor;
import utilities.TextAreaRenderer;
...
public class GenericDetailWindowBlast extends javax.swing.JDialog implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5668772829710498609L;
	...
	private void initGUI(String windowName, String name) {
		...
		try {
			...
			//jPanel11.add(jScrollPane, BorderLayout.CENTER);
...
//		if(this.searchComboBox.getSelectedIndex()==0){
//			buttonStarColumn = this.buildStarColumn(2);
//		}
	}
	...
	private void addTableResizeListener(MouseEvent e) {
		...
		if (e.getButton()==MouseEvent.BUTTON1 && e.getClickCount() == 2) {
			...
			JTable target = (JTable)((MouseEvent) e).getSource();
